...
export class UserController {
  ...
  async findUsers(
    ...
    return await this.userService.findUsers(userId, usersDto);
  }
  ...
  async findme(@GetCurrentUserId() userId: string) {
    return this.userService.findOne(userId, userId);
  }
  ...
  async rejectRequest(
    ...
    return new UserEntity(await this.userService.declineRequest(userId, id));
  }
